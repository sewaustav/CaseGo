...
type PaymentApiService interface {
	...
	UpdateSubscriptionInfoService(ctx context.Context, usr models.UserIdentity, sub dto.UpdateSubscriptionInfoDto) error
	
	DeleteUserService(ctx context.Context, usr models.UserIdentity, userID int64) error

	// for admin
	GiftSubscription(ctx context.Context, usr models.UserIdentity, userID int64) error
