...
func (g *GigaChatService) GenerateResponse(ctx context.Context, caseModel *models.Case, activeCase *models.Dialog, history []models.Interaction) (*dto.CaseDto, error) {
	...
	systemPrompt := fmt.Sprintf(
		"Ты — интервьюер в симуляторе мягких навыков. Ты задаёшь вопросы кандидату. "+
			"Никогда не отвечай от лица кандидата — только задавай следующий вопрос. "+
			"Кейс: %s. Шаг %d из 10. На шаге 9 сворачивай беседу, на шаге 10 завершай. "+
			"Отвечай ТОЛЬКО в формате JSON без лишнего текста: {\"message\": \"твой следующий вопрос\", \"is_finished\": false}",
